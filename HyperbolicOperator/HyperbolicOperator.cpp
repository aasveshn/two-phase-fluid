...
/*
    ...
    std::cout << "Cell " << i 
              << " face_L=" << face_L 
              << " face_R=" << face_R 
              << " flux_L[0]=" << flux[face_L][0]
              << " flux_R[0]=" << flux[face_R][0]
              << " flux_L[1]=" << flux[face_L][1]
              << " flux_R[1]=" << flux[face_R][1]
              << " flux_L[2]=" << flux[face_L][2]
              << " flux_R[2]=" << flux[face_R][2]
              << " flux_L[3]=" << flux[face_L][3]
              << " flux_R[3]=" << flux[face_R][3]
              << " flux_L[4]=" << flux[face_L][4]
              << " flux_R[4]=" << flux[face_R][4]
              << " flux_L[5]=" << flux[face_L][5]
              << " flux_R[5]=" << flux[face_R][5]
              << " flux_L[6]=" << flux[face_L][6]
              << " flux_R[6]=" << flux[face_R][6]
              << " flux_L[7]=" << flux[face_L][7]
              << " flux_R[7]=" << flux[face_R][7]
               << "\n";
}*/ 
